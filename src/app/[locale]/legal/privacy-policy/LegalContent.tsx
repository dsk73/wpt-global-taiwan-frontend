...
function normalizeMarkdown(content: string): string {
  ...
  for (let index = 0; index < lines.length; index += 1) {
    ...
    /*
     * Everything inside a code block remains untouched.
     */
     ...
     * ==========================================================
     *
     * Consecutive normal text lines become separate paragraphs.
     */
 ...
 *   Bold only when subpoints exist
 *
 * Level 3+:
 *   Same size as normal content
 *   Normal weight
...
function LegalParagraph({ children, fullContent }: LegalParagraphProps) {
   ...
   * 2. Privacy
   *
   * Always bold and slightly larger.
   * ==========================================================
   */
   ...
   * LEVEL 4+
   *
   * Normal weight and compact spacing.
   * ==========================================================
   */
  ...
  return (
    <main className="bg-[#050505] text-white">
      {/* ======================================================
          ...
          Back / Legal / Title / Last Updated are intentionally
          handled by page.tsx.

          This component is responsible only for rendering the
          actual Privacy Policy document content.
      ====================================================== */}
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  p: ({ children }) => {
                     ...
                     *
                     * These are treated as bold content.
                     */
